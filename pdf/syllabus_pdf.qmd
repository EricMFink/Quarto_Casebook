...
repo: Quarto_Casebook
course-url: "https://emfink.net/Quarto_Casebook"
...
term: 'Fall 2026'
room: 'Room 204'
meets: 'Mondays, Wednesdays, & Fridays, 10:00–11:30 am'

format:
  pdf:
    template: syllabus.tex
    output-file: Quarto_CasebookSyllabus
...
Civil Procedure: An Open-Source Casebook (v.1.0 2026). Available on the course website: [[emfink.net/Quarto_Casebook](https://www.emfink.net/Quarto_Casebook/)]{.mono-font}.

### Suggested

Kevin M. Clermont, _Principles of Civil Procedure_ (West Academic 7th ed. 2024). This hornbook provides concise overviews of the topics covered in the course. 

## Policies {.unnumbered}

### Grading

Your final grade for the term will be based on a midterm (25%) and final exam (75%):

- The midterm will be open-book/open-note and will consist of multiple choice questions. 
